...
- **Okta Trial Org** — Sign up for a free Okta trial org at [developer.okta.com](https://developer.okta.com). This org will be used across all labs in the series and should not be deleted between labs.
